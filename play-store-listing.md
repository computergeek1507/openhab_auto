...
> Control your openHAB smart home from your car with Android Auto.

Alternatives:
- Manage openHAB smart home devices hands-free in Android Auto.
- Your openHAB smart home, now on the Android Auto dashboard.
...
• **Tap-to-toggle control** — Your devices appear as a clean grid of tiles on the Android Auto screen. Tap a tile to switch it ON or OFF instantly.

• **Clear status at a glance** — Each tile shows the device's name and current state (ON/OFF) with an easy-to-read icon, so you always know what's running.
...
• **Built for Android Auto** — Designed around Android Auto's templated interface and driver-distraction guidelines for a safe, glanceable experience.
...
• A running openHAB server (self-hosted or remote) that your phone can reach.
